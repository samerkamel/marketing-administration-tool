...
<div>
	...
	<div class="text-right">
		<br/>
		<input type="submit" name="submit" value="Edit Invoice" /> or <?php echo anchor(SITE_AREA .'/content/invoice', lang('invoice_cancel')); ?>
	</div>
	<?php echo form_close(); ?>

	<div class="box delete rounded">
		<a class="button" id="delete-me" href="<?php echo site_url(SITE_AREA .'/content/invoice/delete/'. $id); ?>" onclick="return confirm('<?php echo lang('invoice_delete_confirm'); ?>')"><?php echo lang('invoice_delete_record'); ?></a>
		
		<h3><?php echo lang('invoice_delete_record'); ?></h3>
