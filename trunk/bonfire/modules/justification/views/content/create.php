...
<div>
	...
	?>
	<?php echo form_dropdown('usergroup_id', $options, set_value('usergroup_id', isset($invoice['usergroup_id']) ? $invoice['usergroup_id'] : ''))?>
</div>
...
<div>
	...
	?>
	<?php echo form_dropdown('marketingactivity_id', $options, set_value('marketingactivity_id', isset($invoice['marketingactivity_id']) ? $invoice['marketingactivity_id'] : ''))?>
</div>
...
<div>
	...
	?>
	<?php echo form_dropdown('activitytype_id', $options, set_value('activitytype_id', isset($invoice['activitytype_id']) ? $invoice['activitytype_id'] : ''))?>
</div>
...
<div>
	...
	<div class="text-right">
		<br/>
		<input type="submit" name="submit" value="Create Justification" /> or <?php echo anchor(SITE_AREA .'/content/justification', lang('justification_cancel')); ?>
	</div>
	<?php echo form_close(); ?>
