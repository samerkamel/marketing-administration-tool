...
<div class="text-right">
	<br/>
	<input type="submit" name="submit" value="Create PurchaseRequisition" /> or <?php echo anchor(SITE_AREA .'/content/purchaserequisition', lang('purchaserequisition_cancel')); ?>
</div>
<?php echo form_close(); ?>
